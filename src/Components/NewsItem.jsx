...
const NewsItem = ({ title, description, src, url, publishedAt, author }) => {
  ...
  useEffect(() => {
    ...
    const formattedDate = dateObj.toLocaleDateString("en-CA"); // Format: YYYY-MM-DD
    const formattedTime = dateObj.toLocaleTimeString("en-GB"); // Format: HH:MM:SS
    ...
    >
      ...
      <div className="card-body">
        ...
        <p className="card-subtitle mb-1 text-light">
          - {author ? author.slice(0, 90) : "Annonymous"} -
        </p>
